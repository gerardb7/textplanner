...
public class RandomAccessVectorsSimilarity implements SimilarityFunction
{
	...
	public static RandomAccessVectorsSimilarity create(Path vectors_path)
	{
		try
		{
			return new RandomAccessVectorsSimilarity(vectors_path);
		}
		catch (Exception e)
		{
	...
	private RandomAccessVectorsSimilarity(Path vectors_path) throws IOException
	{
