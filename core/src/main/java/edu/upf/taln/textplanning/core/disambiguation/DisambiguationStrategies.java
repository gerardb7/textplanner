package edu.upf.taln.textplanning.core.disambiguation;
...
public class DisambiguationStrategies
{
	...
	public DisambiguationStrategies(double lambda)
	{
		this.lambda = lambda;
	}
	...
	public Map<Mention, Candidate> disambiguate(List<Candidate> candidates)
	{
		...
		return disambiguate(candidates, selected_mentions::contains, DisambiguationStrategies::selectMaxWeightCandidate);
	}
