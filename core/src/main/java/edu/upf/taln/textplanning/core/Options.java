...
public class Options
{
	...
	public Options(Options o)
	{
		...
		this.stopping_threshold = o.stopping_threshold;
	...
	public String toShortString()
	{
		return  "test.cf" + min_context_freq +
				...
				".ot" + DebugUtils.printDouble(stopping_threshold) +
