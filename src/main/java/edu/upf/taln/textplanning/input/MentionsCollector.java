...
class MentionsCollector
{
	...
	static Multimap<String, Mention> collectMentions(SemanticGraph graph)
	{
		log.info("Collecting mentions");
		Stopwatch timer = Stopwatch.createStarted();

		final Multimap<String, Mention> multiwords = collectMultiwordMentions(graph);
		final Multimap<String, Mention> singlewords = collectoSingleWordMentions(graph);
		Multimap<String, Mention> mentions = HashMultimap.create(multiwords);
		mentions.putAll(multiwords);

		log.info("Collected " + mentions.size() +	" where " + singlewords.size() + "are single words and " +
	...
	private static Multimap<String, Mention> collectMultiwordMentions(SemanticGraph graph)
	{
	 ...
	 */
	private static Multimap<String, Mention> collectoSingleWordMentions(SemanticGraph g)
	{
