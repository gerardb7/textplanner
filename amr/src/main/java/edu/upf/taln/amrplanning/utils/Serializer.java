...
//					return ObjectStreamClass.lookup(edu.upf.taln.amrplanning.io.GraphList.class);
//				case "edu.upf.taln.textplanning.structures.io.Candidate":
//					return ObjectStreamClass.lookup(edu.upf.taln.amrplanning.io.Candidate.class);
//				case "edu.upf.taln.textplanning.structures.io.Candidate$Type":
//					return ObjectStreamClass.lookup(edu.upf.taln.amrplanning.io.Candidate.Type.class);
//				case "edu.upf.taln.textplanning.structures.io.CoreferenceChain":
//					return ObjectStreamClass.lookup(edu.upf.taln.amrplanning.io.CoreferenceChain.class);
//				case "edu.upf.taln.textplanning.structures.io.SemanticGraph":
//					return ObjectStreamClass.lookup(edu.upf.taln.amrplanning.io.SemanticGraph.class);
//			}
//			return desc;
//		}
//	}
